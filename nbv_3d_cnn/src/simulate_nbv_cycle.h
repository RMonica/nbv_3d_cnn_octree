...
#define PARAM_VALUE_NBV_ALGORITHM_AutocompleteOctreeIGain "AutocompleteOctreeIGain"
#define PARAM_VALUE_NBV_ALGORITHM_AutocompleteVoxelgridIGain "AutocompleteVoxelgridIGain"
