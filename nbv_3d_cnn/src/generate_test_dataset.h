...
#define PARAM_NAME_SENSOR_RESOLUTION_DOWNSAMPLE     "sensor_resolution_downsample"
#define PARAM_DEFAULT_SENSOR_RESOLUTION_DOWNSAMPLE  (int(1))
...
#define PARAM_NAME_SKIP_VIEW_EVALUATION   "skip_view_evaluation"
#define PARAM_DEFAULT_SKIP_VIEW_EVALUATION (bool(false))
