...
#define PARAM_NAME_PROB_VOXELGRID_NAME           "probabilistic_voxelgrid_name"
#define PARAM_DEFAULT_PROB_VOXELGRID_NAME        ""

#define PARAM_NAME_PROB_VOXELGRID_SUFFIX         "probabilistic_voxelgrid_suffix"
#define PARAM_DEFAULT_PROB_VOXELGRID_SUFFIX      ""
...
#define PARAM_NAME_RAINBOW_THRESHOLD  "rainbow_threshold"
#define PARAM_DEFAULT_RAINBOW_THRESHOLD (double(1.0))
