...
#define PARAM_NAME_INDICES_EXPLICIT       "indices_explicit_" // the index of the folder follows: indices_explicit_0,
                                                              // indices_explicit_1 ...
#define PARAM_DEFAULT_INDICES_EXPLICIT    "ALL"               // explicit list of indices, or ALL
...
#define PARAM_NAME_INITIAL_SCENE_NUM     "initial_scene_num"
#define PARAM_DEFAULT_INITIAL_SCENE_NUM  (int(1))
