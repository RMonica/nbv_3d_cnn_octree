...
public:
  ...
  GenerateTestDataset(ros::NodeHandle & nh): m_nh(nh), m_opencl(m_nh)
  {
    ...
    m_nh.param<bool>(PARAM_NAME_SKIP_VIEW_EVALUATION, m_skip_view_evaluation, PARAM_DEFAULT_SKIP_VIEW_EVALUATION);
...
//        orientation = Eigen::Quaternionf(Eigen::AngleAxisf(M_PI, Eigen::Vector3f::UnitX()));
    ...
    {
      m_generate_single_image->GenerateTestSample(*environment, origins, orientations, cumulative_empty_observation,
