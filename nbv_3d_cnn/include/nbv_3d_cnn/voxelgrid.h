...
class Voxelgrid
{
  ...
  Voxelgrid(const Voxelgrid & other): m_data(other.m_data), m_width(other.m_width), m_height(other.m_height), m_depth(other.m_depth) {}
  ...
  Voxelgrid::Ptr MultipliedBy(const float value) const;

  // arithmetics
  void DivideBy(const Voxelgrid & other);
  Voxelgrid::Ptr AddedTo(const Voxelgrid & other) const;
