...
class INBVAdapter
{
  ...
  virtual void SaveDebugGrids(const std::string & prefix, const Voxelgrid & environment_image) const {}

  virtual StringStringMap GetDebugInfo() const {return StringStringMap(); }
...
class InformationGainNBVAdapter: public INBVAdapter
{
  ...
  StringStringMap GetDebugInfo() const override {return m_last_debug_info; }
