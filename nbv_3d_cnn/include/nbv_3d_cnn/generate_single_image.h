...
class GenerateSingleImage
{
  ...
  uint64 GetViewCubeResolution() const {return m_view_cube_resolution; }
  float GetLastOpenCLComputationTime() const {return m_last_opencl_computation_time; }
  float GetLastUploadTime() const {return m_opencl.GetLastUploadTime(); }
  float GetLastSimulationTime() const {return m_opencl.GetLastSimulationTime(); }
  uint64 GetLastNumberOfRays() const {return m_last_number_of_rays; }
  ...
  float m_last_opencl_computation_time;
  uint64 m_last_number_of_rays;
